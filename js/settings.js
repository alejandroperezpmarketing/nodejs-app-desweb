...
export var MAP_SELECT;//Select interaction. Global so we can remove it later
export var MAP_CLICK_EVENT;//Map click event. Global so we can remove it later
...
//export var WMS_BUILDINGS_LAYER; //Our WMS layer

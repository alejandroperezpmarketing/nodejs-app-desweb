...
export function registerEventsStreets(){
    ...
    document.getElementById('form-streets-delete_street').addEventListener('click',update_street);
    document.getElementById('form-streets-update_street').addEventListener('click',delete_street);

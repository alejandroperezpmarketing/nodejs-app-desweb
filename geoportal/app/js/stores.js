...
export function select_store(){
    ...
    // handle success
            ...
            if (response.data.data.length > 0){
                document.getElementById('form-stores-gid').value=response.data.data[0].gid.value;
                document.getElementById('form-stores-client_segment_id').value=response.data.data[0].client_segment_id.value;
                document.getElementById('form-stores-store_name').value=response.data.data[0].store_name.value;
                document.getElementById('form-stores-store_description').value=response.data.data[0].description.value;
